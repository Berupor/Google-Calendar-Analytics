        ...
        events = [
            {
                ...
                "end": {"dateTime": "2022-02-18T10:30:00+00:00"},
                "summary": "Meeting 1",
            },
            {
                "start": {"dateTime": "2022-02-18T11:00:00+00:00"},
                "end": {"dateTime": "2022-02-18T12:30:00+00:00"},
                "summary": "Meeting 2",
            },
            {
                "start": {"dateTime": "2022-02-18T13:00:00+00:00"},
                "end": {"dateTime": "2022-02-18T14:30:00+00:00"},
                "summary": "Meeting 3",
            },
        ]
        expected_output = pd.DataFrame(
            {
                "Event": ["Meeting 1", "Meeting 2", "Meeting 3"],
                "Duration": [1.5, 1.5, 1.5],
            }
        )
        output = self.transformer.many_events_duration(
            events, max_events=3, ascending=False
        )
